...
public class RefactUtil {
	...
	public static Object invoke(HttpServletRequest request, HttpServletResponse response, Method method,Object controller, Map<String, String[]> parameterMap) {
		...
		try {
			if (method.getParameters().length == 0) {
				...
				result = method.invoke(controller, objects);
			}
